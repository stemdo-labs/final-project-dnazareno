<?php
// require_once("modelo/EntradaModelo.php");
// require_once("modelo/TipoEntradaModelo.php");
...
class EntradasControlador{
    ...
    static function listado(){
        ...
        // require_once("vista/entradas/ListadoEntradasVista.php");
    ...
    static function add(){
        ...
        // si no es OK, nos devolverá de nuevo a la compra
            ...
            // require_once("vista/entradas/ComprarEntradasVista.php");
